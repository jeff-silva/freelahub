<template><div class="app-view">
	...
	<!-- loading -->
	<div v-if="loading">
		<transition enter-active-class="animated fadeIn faster" leave-active-class="animated fadeOut">
			<div class="app-view-loading">
				<slot name="loading">&lt;template v-slot:loading&gt;&hellip;&lt;/template&gt;</slot>
			</div>
		</transition>
	</div>
	<!-- loading -->
	...
	<div v-if="auth">
		...
		<div class="p-2" :class="headerClasses" style="position:fixed; top:0px; left:0px; width:100%; z-index:9; box-shadow:0px 0px 25px 5px #00000033;" ref="header">
			<div class="row no-gutters align-items-center">
				<div class="d-none d-md-block" :class="props.leftClasses">
		...
		<div class="row no-gutters" style="height:100vh;">
			<div class="d-none d-md-block" :class="props.leftClasses" style="height:100vh; overflow:auto; background:#eee;" :style="'padding-top:'+headerHeight+'px !important;'" ref="drawer">
				<slot name="drawer">&lt;template v-slot:drawer&gt;&hellip;&lt;/template&gt;</slot>
			</div>
...
export default {
  ...
  props: {
    ...
    leftClasses: {default:'col-6 col-md-3 col-lg-2'},
